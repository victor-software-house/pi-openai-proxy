...
### Supported in the richer compatibility phase
...
- text
- image content parts using URL or base64 image data
...
- golden tests for models and streaming
...
- model not found
- upstream stream error after partial output
...
- stable features pass unit, integration, golden, and compatibility smoke tests
