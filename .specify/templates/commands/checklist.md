...
1. **Setup**: Resolve `FEATURE_DIR` and `AVAILABLE_DOCS` from the active native `/spec` workspace.
   - All file paths must be absolute.
   - Do not invoke external shell or PowerShell helpers from this template.
